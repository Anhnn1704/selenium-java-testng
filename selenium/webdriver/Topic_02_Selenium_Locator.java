...
public class Topic_02_Selenium_Locator {
   ...
   // String fullName = "Selenium Locator";
    ...
    public void TC_08_XPath(){
        ...
        driver.findElement(By.xpath("//button[@class='btn btn-register-form btn-green-new']"));
        driver.findElement(By.xpath("//button[contains(@class, 'btn-register-form')]"));

        driver.findElement(By.xpath("//a[text()='Mua khóa học']"));

        driver.findElement(By.xpath("//a[contains(text(),'Mua')]"));
        driver.findElement(By.xpath("//a[contains(text(),'khóa')]"));
        driver.findElement(By.xpath("//a[contains(text(),'học')]"));
